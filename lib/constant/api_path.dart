class APIPath {
  ...
  static const String GET_TABLE = BASE_URL + 'TableService/GetTable';
  ...
  static const String GET_FOOD_MENU_POSTTYE =
      BASE_URL + 'ProductService/GetProductPostype';
  static const String CHECK_EXPIRED_PACKAGE =
      BASE_URL + 'PaymentService/checkSubscribeAccount';
  ...
  static const String GET_ORDER_BY_ISSUE_DATE =
      BASE_URL + 'OrderService/GetOrder_byIssuedate';
  static const String GET_ORDER_BY_LIST_ID =
      BASE_URL + 'BillService/GetBill_byIdList';
  static const String GET_SESSION = BASE_URL + 'SessionService/GetByUserStatus';
  static const String CREATE_SESSION =
      BASE_URL + 'SessionService/CreateSession';
  static const String OFF_SESSION = BASE_URL + 'SessionService/CloseSession';
  static const String CREATE_CACULATE_MONEY =
      BASE_URL + 'SessionService/CreateSession';
  ...
  static const String GETSESSION_BY_STATUS =
      BASE_URL + 'SessionService/GetByUserStatus';
  ...
  static const String GET_ORDER_TABLE =
      BASE_URL + 'OrderService/GetOrderTableId';
  static const String GET_CATEGORY = BASE_URL + 'CategoryService/GetCategory';
  static const String UPDATE_ORDER_More =
      BASE_URL + 'OrderService/Update_FoodQty';
  static const String DELETE_ORDER_ALL =
      BASE_URL + 'OrderService/CancelOrder_All';
  static const String DELETE_ORDER_MANY =
      BASE_URL + 'OrderService/CancelOrderMany';
}
